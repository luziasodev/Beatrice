function calcularLucro() {
  ...
  const sociedadeAgua = (aguaValor - (aguaFaxina * 6 + aguaMaquina)) / somaDias;
  ...
  document.getElementById("resultado").innerHTML = `
    ...
    2
          ...
          <p>C: R$ ${total[2].toFixed(2)}. Detalhes: conta de lavagens R$ ${(
    luzLavagem[2] +
    aguaLavagem[1] +
    faxina
    ...
    2
          ...
          <p>D: R$ ${total[3].toFixed(2)}. Detalhes: conta de lavagens R$ ${(
    luzLavagem[3] +
    aguaLavagem[1] +
    faxina
    ...
    2
          ...
          <p>F: R$ ${total[4].toFixed(2)}. Detalhes: conta de lavagens R$ ${(
    luzLavagem[4] +
    aguaLavagem[4] +
    faxina
    ...
    2
          ...
          <p>G: R$ ${total[5].toFixed(2)}. Detalhes: conta de lavagens R$ ${(
    luzLavagem[5] +
    aguaLavagem[5] +
    faxina
